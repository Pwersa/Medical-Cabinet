...
class Ui_Desktop_MainWindow(QtWidgets.QMainWindow):
    ...
    def display_data(self):
        ...
        try:
            try:
                sql = "SELECT * FROM access_history ORDER BY date_time_a DESC"
        ...
        if current_sort[0] == "Datetime":
            try:
                try:
                    ...
                    sql = "SELECT * FROM access_history ORDER BY injury ASC"
                    self.mycursor.execute(sql)
                    self.result = self.mycursor.fetchall()
                ...
                self.tableWidget.setColumnCount(self.numcols)
                self.tableWidget.setRowCount(self.numrows)
                self.sortButton.setText("Sort by Name")
            ...
            try:
                try:
                    ...
                    sql = "SELECT * FROM access_history ORDER BY responder_name ASC"
                    self.mycursor.execute(sql)
                    self.result = self.mycursor.fetchall()
            ...
            try:
                try:
                    ...
                    sql = "SELECT * FROM access_history ORDER BY body_part ASC"
                    self.mycursor.execute(sql)
                    self.result = self.mycursor.fetchall()
            ...
            try:
                ...
                self.tableWidget.setColumnCount(self.numcols)
                self.tableWidget.setRowCount(self.numrows)
                self.sortButton.setText("Sort by Injury")
...
"background-color: rgb(209, 209, 209);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sortButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Sorts the table by a specific column</p></body></html>"))
        self.view_history_button.setToolTip(_translate("MainWindow", "<html><head/><body><p>Opens Emergency History Window</p></body></html>"))
