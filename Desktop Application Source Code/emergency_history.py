...
class Ui_emergency_history(object):
    ...
    def display_data(self):
        ...
        try:
            try:
                sql = "SELECT * FROM emergency_history ORDER BY date_time_e DESC"
    ...
    def sort(self):
        ...
        if current_sort[0] == "Datetime":
            try:
                try:
                    current_sort.clear()
                    current_sort.insert(0, "Injury")
                    sql = "SELECT * FROM emergency_history ORDER BY injury ASC"
                    self.mycursor.execute(sql)
                    self.result = self.mycursor.fetchall()
                ...
                self.tableWidget.setColumnCount(self.numcols)
                self.tableWidget.setRowCount(self.numrows)
                self.sortButton.setText("Sort by Responder")
        ...
        elif current_sort[0] == "Injury":
            try:
                try:
                    current_sort.clear()
                    current_sort.insert(0, "Responder Name")
                    sql = "SELECT * FROM emergency_history ORDER BY responder_name ASC"
                    self.mycursor.execute(sql)
                    self.result = self.mycursor.fetchall()
                ...
                self.tableWidget.setColumnCount(self.numcols)
                self.tableWidget.setRowCount(self.numrows)
                self.sortButton.setText("Sort by Body Part")
        ...
        elif current_sort[0] == "Responder Name":
            try:
                try:
                    current_sort.clear()
                    current_sort.insert(0, "Body Part")
                    sql = "SELECT * FROM emergency_history ORDER BY body_part ASC"
                    self.mycursor.execute(sql)
                    self.result = self.mycursor.fetchall()
                ...
                self.tableWidget.setColumnCount(self.numcols)
                self.tableWidget.setRowCount(self.numrows)
                self.sortButton.setText("Sort by Patient")
        ...
        elif current_sort[0] == "Body Part":
            try:
                try:
                    current_sort.clear()
                    current_sort.insert(0, "Patient Name")
                    sql = "SELECT * FROM emergency_history ORDER BY patient_name ASC"
                    self.mycursor.execute(sql)
                    self.result = self.mycursor.fetchall()
                ...
                self.tableWidget.setColumnCount(self.numcols)
                self.tableWidget.setRowCount(self.numrows)
                self.sortButton.setText("Sort by Gender")
        ...
        elif current_sort[0] == "Patient Name":
            try:
                try:
                    current_sort.clear()
                    current_sort.insert(0, "Patient Gender")
                    sql = "SELECT * FROM emergency_history ORDER BY patient_gender ASC"
                    self.mycursor.execute(sql)
                    self.result = self.mycursor.fetchall()
                ...
                self.tableWidget.setColumnCount(self.numcols)
                self.tableWidget.setRowCount(self.numrows)
                self.sortButton.setText("Sort by Age")
        ...
        elif current_sort[0] == "Patient Gender":
            try:
                try:
                    current_sort.clear()
                    current_sort.insert(0, "Datetime")
                    sql = "SELECT * FROM emergency_history ORDER BY patient_age ASC"
                    self.mycursor.execute(sql)
                    self.result = self.mycursor.fetchall()
                ...
                self.tableWidget.setColumnCount(self.numcols)
                self.tableWidget.setRowCount(self.numrows)
                self.sortButton.setText("Sort by Datetime")
    ...
    def export(self):
        ...
        self.sorted_by = str(current_sort[0])
        self.path = str("C:/Users/" + self.username)
        self.directory = str(self.path + '/Desktop/' + self.formatted_datetime + ' ' + self.sorted_by + ' Access History.xlsx')
        ...
        df.to_excel(self.directory, index=False)
    ...
    def setupUi(self, MainWindow):
        ...
        self.sortButton.setMinimumSize(QtCore.QSize(145, 45))
        self.sortButton.setMaximumSize(QtCore.QSize(16777215, 60))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.sortButton.setStyleSheet("background-color: rgb(209, 209, 209);")
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sortButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Sorts the table based on a specific column</p></body></html>"))
        ...
        self.sortButton.setText(_translate("MainWindow", "Sort By Injury"))
