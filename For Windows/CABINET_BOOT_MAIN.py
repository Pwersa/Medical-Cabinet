...
class Ui_scan_qr_code(QMainWindow):
    ...
    def restart_program(self):
        if len(restart_button) >= 5:
            ...
            #subprocess.run(["config/cabinet_on_start.sh")
            window.refresh()
        else:
...
class Ui_gender_patient_window(QMainWindow):
    ...
    def old_send(self):
        ...
        try:
            ...
            s.close() # close the socket
            #os.remove("cabinet-history/session/recorded_session" + " " + session[0] + ".csv")
            print("LAMAN NG SESSION >>>>>>>>>>")
            print(session)
...
class Ui_end_session_confirmation(QMainWindow):
    def __init__(self):
        ...
        loadUi("end_confirmation.ui", self)
...
class Ui_close_program_confirmation(QMainWindow):
    def __init__(self):
        ...
        loadUi("close_confirmation.ui", self)
