...
class Ui_procedure_window(object):
    def setupUi(self, procedure_window):
        ...
        self.next_step_button = QtWidgets.QPushButton(self.centralwidget, clicked = self.next_procedure)
    ...
    def next_procedure(self):
        ...
        print(self.text_injury)
        if self.text_injury == "CUT":
            self.title_step.setText("STEP 2: Clean the wound")
            self.text_steps.setText("Rinse the wound with water. Keeping the wound under running tap water will reduce the risk of infection \n If water is not available, use betadine solution to clean the wound.")
            self.injury_type_label.setText("CUT")
            
            self.cut_gif2 = QMovie("GIFs/cuts-2.gif")
            self.gif_player_label.setMovie(self.cut_gif2)
            self.cut_gif2.start()
    ...
    def retranslateUi(self, procedure_window):
        ...
        self.title_step.setText(_translate("procedure_window", "<html><head/><body><p><span style=\" font-size:24pt;\">Example STEP #: LOREM IPSUM</span></p></body></html>"))
        self.text_steps.setText(_translate("procedure_window", "<html><head/><body><p align=\"center\">PROCEDURE HERE</p></body></html>"))
        self.gif_player_label.setText(_translate("procedure_window", "GIF PLAYER HERE"))
...
" BODY PARTS"))
        self.injury_type_label.setText(_translate("procedure_window", "<html><head/><body><p><span style=\" font-size:24pt;\">Example Injury Type</span></p></body></html>"))
