...
class qr_scanner_window(object):
    ...
    def open_qr_scanner(self):
        ...
        qr_window_app.destroy()
        self.open_select_body_part()
        
    def open_select_body_part(self):
        self.window_body_parts = QtWidgets.QMainWindow()
        self.ui = select_body_part()
        self.ui.setupUi(self.window_body_parts)
        self.window_body_parts.show()
    ...
    def retranslateUi(self, qr_window_app):
...
if __name__ == "__main__":
    ...
    qr_window_app = QtWidgets.QMainWindow()
    ui = qr_scanner_window()
    ui.setupUi(qr_window_app)
    qr_window_app.show()
    sys.exit(app.exec_())
